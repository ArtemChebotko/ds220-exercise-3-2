...
<div class="step-title">Increment a counter</div>


✅ Simulate adding a tag for another video by incrementing the video count for a category, and then querying the new count from the `videos_count_by_tag` table:
```
