    ...
    <div class="container px-4 py-2">
     <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
      <div class="feature col div-choice">
        ...
        <br/>
        <div class="scenario-objectives">In this hands-on lab, you explored how to:</div>
        <ul>
              <li><span class="scenario-objective">Create a keyspace for KillrVideo</span></li>
              <li><span class="scenario-objective">Create a new table that makes use of the counter type</span></li>
              <li><span class="scenario-objective">Load the newly created table with data</span></li>
              <li><span class="scenario-objective">Run queries against the table to test counter functionality</span></li>
        </ul>
